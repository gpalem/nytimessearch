package gangireddyp.nytimessearch.dialogs;
...
import gangireddyp.nytimessearch.activities.NyTimesSearchActivity;

/**
 * Created by gpalem on 2/13/16.
 */
public class FilterDialog extends DialogFragment implements DatePickerDialog.OnDateSetListener {
    ...
    @Bind(R.id.tbSortOrder) ToggleButton tbSotOrder;
    ...
    @Bind(R.id.ibCalendar) ImageButton ibCalendar;

    NyTimesSearchActivity parentActivity;
    public FilterDialog() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        parentActivity = (NyTimesSearchActivity) getActivity();
