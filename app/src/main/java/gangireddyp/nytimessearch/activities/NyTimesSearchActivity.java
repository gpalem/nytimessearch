package gangireddyp.nytimessearch.activities;
...
import gangireddyp.nytimessearch.R;
import gangireddyp.nytimessearch.adapters.ArticleAdapter;
import gangireddyp.nytimessearch.dialogs.FilterDialog;
import gangireddyp.nytimessearch.listeners.EndlessRecyclerViewScrollListener;
import gangireddyp.nytimessearch.models.ArticleModel;

;

public class NyTimesSearchActivity extends AppCompatActivity {

    private static final String TAG = NyTimesSearchActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ny_times_search);
